...
export function ProfilePreferencesPage() {
    ...
    const [hideAmountsByDefault, setHideAmountsByDefault] = useState(
        user?.preferences.hideAmountsByDefault ?? false,
    );
    ...
    return (
        ...
        >
            <section className="space-y-5 border-y border-border/60 py-4">
                ...
                <div className="space-y-3 border-t border-border/60 pt-4">
                    <div className="space-y-1">
                        ...
                        <p className="text-xs text-muted-foreground">
                            Define se os montantes entram ocultos por defeito ao
                            abrir a app.
                        </p>
                    </div>
                    ...
                    onClick={async () => {
                        try {
                            ...
                            toast.error(
                                getErrorMessage(
                                    error,
                                    "Não foi possível atualizar preferências",
                                ),
                            );
                        }
                    }}
                    ...
                    onClick={async () => {
                        try {
                            ...
                            toast.error(
                                getErrorMessage(
                                    error,
                                    "Não foi possível reiniciar tutorial",
                                ),
                            );
                        }
                    }}
