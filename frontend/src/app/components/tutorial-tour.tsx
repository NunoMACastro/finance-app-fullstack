...
const TOUR_STEPS_BY_SCOPE: Record<TourScope, TourStep[]> = {
  ...
  stats: [
    ...HEADER_TOUR_STEPS,
    {
      ...
      description: "Escolhe entre 6M e 12M para atualizar o contexto analítico da conta ativa.",
    },
    {
      id: "stats-pulse",
      selector: '[data-tour="stats-pulse"]',
      title: "Pulse do período",
      description: "Aqui tens o estado geral: saldo, desvio de orçamento e recomendação de ação.",
    },
    {
      id: "stats-trend",
      selector: '[data-tour="stats-trend-chart"]',
      title: "Tendência mensal",
      description: "Segue a evolução de receitas, despesas e saldo ao longo do tempo.",
    },
    {
      id: "stats-drivers",
      selector: '[data-tour="stats-drivers"]',
      title: "Drivers principais",
      description: "As categorias com maior impacto aparecem aqui; toca numa linha para ver detalhe.",
    },
  ],
};
