...
>(({ className, children, onOpenAutoFocus, "aria-describedby": ariaDescribedBy, ...props }, ref) => (
  <DialogPortal data-slot="dialog-portal">
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        "bg-card/95 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-[50%] left-[50%] z-[60] grid w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-[20px] border border-border/80 p-5 shadow-overlay duration-200 backdrop-blur-xl sm:max-w-lg",
        className,
      )}
