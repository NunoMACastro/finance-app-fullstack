...
import { CURRENCY_OPTIONS, SELECT_CLASS_NAME } from "./profile-options";
  ...
  return (
    ...
    >
      ...
      <section className="space-y-3 border-b border-border/60 pb-4">
        <div className="space-y-1">
          <label className="text-xs text-muted-foreground">Novo email</label>
          <Input
            value={newEmail}
      ...
      <section className="space-y-3 border-b border-border/60 pb-4">
        <p className="text-xs text-muted-foreground">Dados e privacidade</p>
        <Button
          type="button"
          variant="outline"
        ...
        <div className="space-y-2 rounded-xl border border-danger/40 bg-danger-soft p-3">
          ...
          <Button
            type="button"
            className="h-11 w-full rounded-xl bg-danger text-danger-foreground hover:bg-danger/90"
